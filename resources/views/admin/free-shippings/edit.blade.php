...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">編輯免運費活動</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.free-shippings.update', $freeShipping) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control flatpickr @error('end_date') is-invalid @enderror"
                                    ...
                                    value="{{ old('end_date', $freeShipping->end_date) }}" >
                                @error('end_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3 d-flex align-items-center">
                                <input type="checkbox" class="form-check-input p-1" id="is_active" name="is_active"
                                    value="1" {{ old('is_active', $freeShipping->is_active) ? 'checked' : '' }}>
