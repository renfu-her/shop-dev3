                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide d-flex justify-content-end">
                                        <div class="ratio rtl-flip"
                                            ...
                                            <img src="{{ asset('frontend/img/home/electronics/hero-slider/01.png') }}"
                                                alt="Image">
                                        </div>
                                    </div>
                                    <div class="swiper-slide d-flex justify-content-end">
                                        <div class="ratio rtl-flip"
                                            style="max-width: 495px; --cz-aspect-ratio: calc(537 / 495 * 100%)">
                                            <img src="{{ asset('frontend/img/home/electronics/hero-slider/02.png') }}"
                                                alt="Image">
                                        </div>
                                    </div>
                                    <div class="swiper-slide d-flex justify-content-end">
                                        <div class="ratio rtl-flip"
                                            style="max-width: 495px; --cz-aspect-ratio: calc(537 / 495 * 100%)">
                                            <img src="{{ asset('frontend/img/home/electronics/hero-slider/03.png') }}"
                                                alt="Image">
                                        </div>
                                    </div>
                                </div>
    ...
    {{-- <section class="container pt-5 mt-1 mt-sm-2 mt-md-3 mt-lg-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-4" data-bs-theme="dark">
                    <div class="d-flex flex-column align-items-center justify-content-end h-100 text-center overflow-hidden rounded-5 px-4 px-lg-3 pt-4 pb-5"
                        ...
                        <div class="ratio animate-up-down position-relative z-2 me-lg-4"
                            ...
                            <img src="{{ asset('frontend/img/home/electronics/banner/laptop.png') }}"
                                alt="Laptop">
                        </div>
                ...
                <div class="col-sm-6 col-lg-4 d-flex flex-column gap-3 pt-4 py-lg-4">
                    ...
                    <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
                        <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                            <img src="{{ asset('frontend/img/shop/electronics/thumbs/01.png') }}"
                                alt="Smart Watch">
                        </div>
                    ...
                    <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
                        <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                            <img src="{{ asset('frontend/img/shop/electronics/thumbs/03.png') }}" width="110"
                                alt="VR Glasses">
                        </div>
                        <div class="w-100 min-w-0 ps-2 ps-sm-3">
                            <div class="d-flex align-items-center gap-2 mb-2">
                    ...
                    <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
                        <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                            <img src="{{ asset('frontend/img/shop/electronics/thumbs/05.png') }}" width="110"
                    ...
                    <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
                        <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                            <img src="{{ asset('frontend/img/shop/electronics/thumbs/07.png') }}" width="110"
                                alt="MacBook">
                        </div>
                        <div class="w-100 min-w-0 ps-2 ps-sm-3">
                            <div class="d-flex align-items-center gap-2 mb-2">
                ...
                <div class="col-sm-6 col-lg-4 d-flex flex-column gap-3 pt-3 py-lg-4">
                    ...
                    <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
                        <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                            <img src="{{ asset('frontend/img/shop/electronics/thumbs/02.png') }}" width="110"
                                alt="iPad Pro">
                        </div>
                        <div class="w-100 min-w-0 ps-2 ps-sm-3">
                            <div class="d-flex align-items-center gap-2 mb-2">
                    ...
                    <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
                        <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                            <img src="{{ asset('frontend/img/shop/electronics/thumbs/04.png') }}" width="110"
                                alt="AirPods 2 Pro">
                        </div>
                        <div class="w-100 min-w-0 ps-2 ps-sm-3">
                            <div class="d-flex align-items-center gap-2 mb-2">
                            ...
                            <h4 class="mb-2">
                                <a class="stretched-link d-block fs-sm fw-medium text-truncate"
                                    href="shop-product-general-electronics.html"><span
                                        class="animate-target">Headphones Apple AirPods 2 Pro</span></a>
                            </h4>
                            <div class="h5 mb-0">$209.99 <del
                                    class="text-body-tertiary fs-sm fw-normal">$356.00</del></div>
                        </div>
                    </div>
                    ...
                    <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
                        <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                            <img src="{{ asset('frontend/img/shop/electronics/thumbs/06.png') }}" width="110"
                                alt="Power Bank">
                        </div>
                        <div class="w-100 min-w-0 ps-2 ps-sm-3">
                            <div class="d-flex align-items-center gap-2 mb-2">
                    ...
                    <div class="position-relative animate-underline d-flex align-items-center ps-xl-3">
                        ...
                        <div class="w-100 min-w-0 ps-2 ps-sm-3">
                            ...
                            <div class="h5 mb-0">$899.00 <del
                                    class="text-body-tertiary fs-sm fw-normal">$958.00</del></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="position-relative">
                        ...
                        <a class="d-block rounded-top overflow-hidden p-3 p-sm-4"
                            ...
                            <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                <img src="{{ asset('frontend/img/shop/electronics/01.png') }}" alt="VR Glasses">
                            </div>
                        </a>
                    </div>
                ...
                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                    <div class="position-relative">
                        ...
                        <a class="d-block rounded-top overflow-hidden p-3 p-sm-4"
                            href="shop-product-general-electronics.html">
                            <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                <img src="{{ asset('frontend/img/shop/electronics/02.png') }}" alt="iPhone 14">
                            </div>
                        </a>
                    </div>
                    <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
                ...
                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                    <div class="position-relative">
                        ...
                        <a class="d-block rounded-top overflow-hidden p-3 p-sm-4"
                            href="shop-product-general-electronics.html">
                            <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                <img src="{{ asset('frontend/img/shop/electronics/03.png') }}" alt="Smart Watch">
                            </div>
                        </a>
                    </div>
                    <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
                ...
                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                    <div class="position-relative">
                        ...
                        <a class="d-block rounded-top overflow-hidden p-3 p-sm-4"
                            ...
                            <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                <img src="{{ asset('frontend/img/shop/electronics/04.png') }}" alt="MacBook">
                            </div>
                        </a>
                    </div>
                    <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
                ...
                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                    <div class="posittion-relative">
                        ...
                        <a class="d-block rounded-top overflow-hidden p-3 p-sm-4"
                            href="shop-product-general-electronics.html">
                            <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                <img src="{{ asset('frontend/img/shop/electronics/05.png') }}" alt="iPad Air">
                            </div>
                        </a>
                    </div>
                    <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
                ...
                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                    <div class="position-relative">
                        ...
                        <a class="d-block rounded-top overflow-hidden p-3 p-sm-4"
                            href="shop-product-general-electronics.html">
                            <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                <img src="{{ asset('frontend/img/shop/electronics/06.png') }}" alt="AirPods 2">
                            </div>
                        </a>
                    </div>
                    <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
                ...
                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                    <div class="posittion-relative">
                        ...
                        <a class="d-block rounded-top overflow-hidden p-3 p-sm-4"
                            href="shop-product-general-electronics.html">
                            <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                <img src="{{ asset('frontend/img/shop/electronics/07.png') }}" alt="iPad Pro">
                            </div>
                        </a>
                    </div>
                    <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
                ...
                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                    <div class="posittion-relative">
                        ...
                        <a class="d-block rounded-top overflow-hidden p-3 p-sm-4"
                            href="shop-product-general-electronics.html">
                            <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                <img src="{{ asset('frontend/img/shop/electronics/08.png') }}"
                                    alt="Bluetooth Headphones">
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="row align-items-center position-relative z-2">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <div class="text-center text-md-start py-md-5 px-4 ps-md-5 pe-md-0 me-md-n5">
                                <h3 class="text-uppercase fw-bold ps-xxl-3 pb-2 mb-1">Seasonal weekly sale 2024
                                </h3>
                        ...
                        <div class="col-md-6 d-flex justify-content-center justify-content-md-end pb-5 pb-md-0">
                            <div class="me-xxl-4">
                                <img src="{{ asset('frontend/img/home/electronics/banner/camera.png') }}"
                                    class="d-block rtl-flip" width="420" alt="Camera">
                        ...
                        <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                            <div class="position-relative">
                                ...
                                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4"
                                    href="shop-product-general-electronics.html">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                        <img src="{{ asset('frontend/img/shop/electronics/09.png') }}"
                                            alt="Wireless Buds">
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                            <div class="position-relative">
                                ...
                                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4"
                                    href="shop-product-general-electronics.html">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                        <img src="{{ asset('frontend/img/shop/electronics/11.png') }}"
                                            alt="Nikon Camera">
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                            <div class="position-relative">
                                ...
                                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4"
                                    href="shop-product-general-electronics.html">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                        <img src="{{ asset('frontend/img/shop/electronics/10.png') }}" alt="iPhone 14">
                                    </div>
                                </a>
                            </div>
                            <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
                        ...
                        <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                            <div class="position-relative">
                                ...
                                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4"
                                    href="shop-product-general-electronics.html">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                        <img src="{{ asset('frontend/img/shop/electronics/01.png') }}"
                                            alt="VR Glasses">
                                    </div>
                                </a>
                            </div>
        ...
        <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-6 g-3 g-md-4 g-lg-3 g-xl-4">
            <div class="col">
                <a class="btn btn-outline-secondary w-100 rounded-4 p-3" href="shop-catalog-electronics.html">
                    <img src="{{ asset('frontend/img/shop/electronics/brands/apple-light-mode.svg') }}"
                        class="d-none-dark" alt="Apple">
                    <img src="{{ asset('frontend/img/shop/electronics/brands/apple-dark-mode.svg') }}"
                        class="d-none d-block-dark" alt="Apple">
                </a>
            </div>
            <div class="col">
                <a class="btn btn-outline-secondary w-100 rounded-4 p-3" href="shop-catalog-electronics.html">
                    <img src="{{ asset('frontend/img/shop/electronics/brands/motorola-light-mode.svg') }}"
                        class="d-none-dark" alt="Apple">
                    <img src="{{ asset('frontend/img/shop/electronics/brands/motorola-dark-mode.svg') }}"
                        class="d-none d-block-dark" alt="Apple">
                </a>
            </div>
            <div class="col">
                <a class="btn btn-outline-secondary w-100 rounded-4 p-3" href="shop-catalog-electronics.html">
                    <img src="{{ asset('frontend/img/shop/electronics/brands/canon-light-mode.svg') }}"
                        class="d-none-dark" alt="Apple">
                    <img src="{{ asset('frontend/img/shop/electronics/brands/canon-dark-mode.svg') }}"
                        class="d-none d-block-dark" alt="Apple">
                </a>
            </div>
            <div class="col">
                <a class="btn btn-outline-secondary w-100 rounded-4 p-3" href="shop-catalog-electronics.html">
                    <img src="{{ asset('frontend/img/shop/electronics/brands/samsung-light-mode.svg') }}"
                        class="d-none-dark" alt="Apple">
                    <img src="{{ asset('frontend/img/shop/electronics/brands/samsung-dark-mode.svg') }}"
                        class="d-none d-block-dark" alt="Apple">
                </a>
            </div>
            <div class="col">
                <a class="btn btn-outline-secondary w-100 rounded-4 p-3" href="shop-catalog-electronics.html">
                    <img src="{{ asset('frontend/img/shop/electronics/brands/sony-light-mode.svg') }}"
                        class="d-none-dark" alt="Apple">
                    <img src="{{ asset('frontend/img/shop/electronics/brands/sony-dark-mode.svg') }}"
                        class="d-none d-block-dark" alt="Apple">
                </a>
            </div>
            <div class="col">
                ...
                <div class="col-md-6 col-lg-5 col-xl-4 offset-lg-1 offset-xl-2">
                    <ul class="list-unstyled d-flex flex-column gap-4 ps-md-4 ps-lg-0 mb-3">
                        <li class="nav flex-nowrap align-items-center position-relative">
                            <img src="{{ asset('frontend/img/home/electronics/vlog/01.jpg') }}" class="rounded"
                        ...
                        <li class="nav flex-nowrap align-items-center position-relative">
                            <img src="{{ asset('frontend/img/home/electronics/vlog/02.jpg') }}" class="rounded"
                                width="140" alt="Video cover">
                            <div class="ps-3">
                        ...
                        <li class="nav flex-nowrap align-items-center position-relative">
                            <img src="{{ asset('frontend/img/home/electronics/vlog/03.jpg') }}" class="rounded"
                                width="140" alt="Video cover">
                            <div class="ps-3">
